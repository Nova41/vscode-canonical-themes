...
export const theme: ThemeDefinition = {
  name: 'Canonical - Catppuccin Latte',
  uiTheme: 'vs',
  colors: {
    'activityBar.background': palette.gray7,
    ...
    'editor.background': palette.gray1,
    'editor.foreground': palette.gray7,
    'editorIndentGuide.background1': palette.gray7 + '1F',
    ...
    'tab.activeBackground': palette.gray1,
    'tab.activeBorder': palette.gray1,
    'tab.activeBorderTop': palette.mauve,
    'tab.border': palette.gray4,
    'tab.inactiveBackground': palette.gray3,
    'tab.inactiveForeground': palette.gray6,
    'titleBar.border': palette.gray4,
    'titleBar.activeBackground': palette.gray3,
    'titleBar.activeForeground': palette.gray7,
    'titleBar.inactiveBackground': palette.gray3,
    'titleBar.inactiveForeground': palette.gray7,
    'terminal.ansiBlack': palette.gray7,
    ...
    'terminal.ansiWhite': palette.gray2,
    'terminal.ansiBrightBlack': palette.gray6,
    'terminal.ansiBrightRed': palette.maroon,
    'terminal.ansiBrightGreen': palette.green,
    'terminal.ansiBrightYellow': palette.peach,
    'terminal.ansiBrightBlue': palette.sapphire,
    'terminal.ansiBrightMagenta': palette.pink,
    'terminal.ansiBrightCyan': palette.sky,
    'terminal.ansiBrightWhite': palette.gray1,
